...
})({"bkznC":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
const H = new _highwayDefault.default.Core({
    renderers: {
        name: _customRendererJsDefault.default
    },
    transitions: {
        name: _customTransitionJsDefault.default,
        default: _customTransitionJsDefault.default
    }
});
...
var _highway = require("@dogstudio/highway");
var _highwayDefault = parcelHelpers.interopDefault(_highway);
class CustomRenderer extends _highwayDefault.default.Transition {
    // Hooks/methods
    onEnter() {
    // [...]
    }
...
class Fade extends _highwayDefault.default.Transition {
    in({ from , to , done  }) {
        // Reset Scroll
        window.scrollTo(0, 0);
        // Remove Old View
        ...
        if (brassToken && !brassToken.firstChild) brassToken.appendChild(document.createTextNode(getFormattedTimeSince('8/30/2021')));
        //VFS-Ambassador Auto Month Calc
        var vfsAmbassador = document.getElementById('VFS-Ambassador');
        if (vfsAmbassador && !vfsAmbassador.firstChild) vfsAmbassador.appendChild(document.createTextNode(getFormattedTimeSince('2/1/2022')));
        // Animation
        _gsapDefault.default.fromTo(to, 0.5, {
            opacity: 0
        }, {
            opacity: 1,
            onComplete: done
    ...
    out({ from , done  }) {
        // Animation
        _gsapDefault.default.fromTo(from, 0.5, {
            opacity: 1
        }, {
            opacity: 0,
            onComplete: done
...
},{"@dogstudio/highway":"26LRT","gsap":"fPSuC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["bkznC","77ZHc"], "77ZHc", "parcelRequiredddd")
