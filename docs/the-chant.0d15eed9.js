...
})({"ilFQz":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "ae6364550d15eed9";
...
},{}],"77ZHc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _highway = require("@dogstudio/highway");
var _highwayDefault = parcelHelpers.interopDefault(_highway);
// Import Renderers
var _customRendererJs = require("../js/js-transitions/custom-renderer.js");
var _customRendererJsDefault = parcelHelpers.interopDefault(_customRendererJs);
// Import Transitions
var _customTransitionJs = require("../js/js-transitions/custom-transition.js");
var _customTransitionJsDefault = parcelHelpers.interopDefault(_customTransitionJs);
// Call Highway.Core once.
// Relate transitions to pages with the label of the `data-router-view`.
const H = new (0, _highwayDefault.default).Core({
    renderers: {
        name: (0, _customRendererJsDefault.default)
    },
    transitions: {
        name: (0, _customTransitionJsDefault.default),
        default: (0, _customTransitionJsDefault.default)
    }
});
...
function manageScripts(to) {
    ...
    const a = [
        ...to.page.querySelectorAll("script:not([data-no-reload])")
    ];
    const b = [
        ...document.querySelectorAll("script:not([data-no-reload])")
    ];
    //Compare Scripts
    for(let i = 0; i < b.length; i++){
        ...
        for(let j = 0; j < a.length; j++){
            ...
            if (c.outerHTML === d.outerHTML) {
                ...
                // Inline Script
                if (c.innerHTML) script.innerHTML = c.innerHTML;
                // Replace
    ...
    // Remove Useless
    for (const script1 of b)//Remove
    script1.parentNode.removeChild(script1);
    // Add Scripts
    for (const script2 of a){
        const loc = script2.parentNode.tagName;
        if (loc === "HEAD") document.head.appendChild(script2);
        loc;
    }
}

},{"@dogstudio/highway":"26LRT","../js/js-transitions/custom-renderer.js":"3r3zB","../js/js-transitions/custom-transition.js":"7nHgg","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"26LRT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"3r3zB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _highway = require("@dogstudio/highway");
var _highwayDefault = parcelHelpers.interopDefault(_highway);
class CustomRenderer extends (0, _highwayDefault.default).Transition {
    // Hooks/methods
    onEnter() {
    // [...]
    }
...
},{"@dogstudio/highway":"26LRT","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"7nHgg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _highway = require("@dogstudio/highway");
var _highwayDefault = parcelHelpers.interopDefault(_highway);
...
class Fade extends (0, _highwayDefault.default).Transition {
    in({ from , to , done  }) {
        ...
        $(".filters").on("click", "button", function() {
            ...
            for(let i = 0; i < activeButtons.length; i++)activeButtons[i].classList.remove("projects-button-active");
        ...
        function getFormattedTimeSince(start) {
            ...
            if (months >= 12) formattedTime = years + " yr " + remainingMonths + " mos";
            else formattedTime = months + " mos";
        ...
        for(let i = 0; i < heroVideos.length; i++)if (heroVideos[i].paused) {
            ...
            for(let i1 = 0; i1 < heroVideos.length; i1++)if (heroVideos[i1].paused) {
                heroVideos[i1].play();
                console.log("Hero Video %d, Wasn't Playing, Playing & Re-looping", i1);
                forceAutoPlay();
            } else console.log("Hero Video %d, Already Playing Continuing", i1);
...
},{"@dogstudio/highway":"26LRT","gsap":"fPSuC","jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fPSuC":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./gsap-core.js":"05eeC","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}]},["ilFQz","77ZHc"], "77ZHc", "parcelRequiredddd")

//# sourceMappingURL=the-chant.0d15eed9.js.map
